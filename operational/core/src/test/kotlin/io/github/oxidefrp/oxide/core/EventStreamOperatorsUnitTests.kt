...
import io.github.oxidefrp.oxide.core.test_framework.shared.CellSpec
import io.github.oxidefrp.oxide.core.test_framework.shared.CellValueDesc
...
import io.github.oxidefrp.oxide.core.test_framework.shared.FiniteInputStreamSpec
import io.github.oxidefrp.oxide.core.test_framework.shared.InfiniteInputStreamSpec
import io.github.oxidefrp.oxide.core.test_framework.shared.MomentSpec
import io.github.oxidefrp.oxide.core.test_framework.shared.TestCheck
import io.github.oxidefrp.oxide.core.test_framework.shared.TestSpec
...
import io.github.oxidefrp.oxide.core.test_framework.shared.withTail
import io.github.oxidefrp.oxide.core.test_framework.testSystem
import kotlin.test.Test

class EventStreamOperatorsUnitTests {
    @Test
    fun testCurrentOccurrence() = testSystem {
    ...
    @Test
    fun testMapInfinite() = testSystem {
            ...
            checks = listOf(
                TestCheck(
                    ...
                    spec = EventStreamSpec(
                        matchFrontEventsOnly = true,
                        expectedEvents = listOf(
                            EventOccurrenceDesc(tick = Tick.Zero, event = "Fizz Buzz"),
            ...
            checks = listOf(
                TestCheck(
                    ...
                    spec = EventStreamSpec(
                        matchFrontEventsOnly = true,
                        expectedEvents = listOf(
                            EventOccurrenceDesc(tick = Tick.Zero, event = 0),
                            EventOccurrenceDesc(tick = Tick(t = 2), event = 2),
                            EventOccurrenceDesc(tick = Tick(t = 4), event = 4),
    ...
    @Test
    fun testMergeWithNonSimultaneous() = testSystem {
    ...
    @Test
    fun testMergeWithSimultaneous() = testSystem {
        val sourceStream1 = buildInputStream(
            FiniteInputStreamSpec(
                EventOccurrenceDesc(tick = Tick(t = 1), event = "a"),
                EventOccurrenceDesc(tick = Tick(t = 5), event = "b"),
